...
-- Navigation keymaps
vim.keymap.set('n', '<BS>', '<Cmd>BufferClose<CR>', opts)
vim.keymap.set('n', '<Tab>', '<Cmd>BufferNext<CR>', opts)
vim.keymap.set('n', '<S-Tab>', '<Cmd>BufferPrevious<CR>', opts)
vim.keymap.set('n', '<C-f>', '<Cmd>NvimTreeToggle<CR>', opts)
...
require('lazy').setup({
  ...
  },
  {
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'typescript', 'luadoc', 'markdown', 'vim', 'vimdoc' },
      auto_install = true,
      highlight = {
        enable = true,
